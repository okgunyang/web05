				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" id="paytype" name="paytype" value="${sales.paytype }" disabled/>
								<input type="text" id="payplace" name="payplace" value="${sales.payplace }" disabled/>
								<input type="text" id="payno" name="payno" value="${sales.payno }" disabled/> 
							</td>
						</tr>
						<tr>
							<th><label for="rname">수신자 정보</label></th>
							<td>수신자명 : <input type="text" name="rname" id="rname" class="single100" value="${sales.rname }" disabled><br><br>
								연락처 : <input type="text" name="tel" id="tel" class="single100" value="${sales.tel }" disabled><br><br>
								기본 주소 : <input type="text" name="addr1" id="addr1" class="single100" value="${sales.addr1 }" disabled><br><br>
								상세 주소 : <input type="text" name="addr2" id="addr2" class="single100" value="${sales.addr2 }" disabled><br><br>
								우편번호 :  <input type="text" name="postcode" id="postcode" class="single100" value="${sales.postcode }" disabled>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<c:if test="${!empty sales.rstatus}">
								<input type="text" name="rstate1" id="rstate1" class="single100" value="${sales.rstatus}" disabled>
								</c:if>
							</td>
						</tr>
						<tr>
